...
{  test("test logging out a user", async () => 
     {  const client = new TestClient(process.env.TEST_HOST as string);
       ...
       // await axios.post(  process.env.TEST_HOST as string,  {   query: loginMutation(email, password)  },  {  withCredentials: true  }  );
       ...
       // await axios.post( process.env.TEST_HOST as string, {  query: logoutMutation  },  {  withCredentials: true  }  );
       // const response2 = await axios.post( process.env.TEST_HOST as string,  {  query: meQuery  },  { withCredentials: true  } );
